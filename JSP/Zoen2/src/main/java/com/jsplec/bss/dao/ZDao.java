...
public class ZDao {
	...
	// 제품 검색
		...
		public void order(String cId, int pId, int oQuantity) {
			...
			try {
				...
				String query = "insert into orders (cId, pId, delivery_id, oQuantity, oDate) values (?,?,1,1,now())";
				preparedStatement = connection.prepareStatement(query);
				preparedStatement.setString(1, cId);
				preparedStatement.setInt(2, pId);
				//preparedStatement.setInt(3, oQuantity);
