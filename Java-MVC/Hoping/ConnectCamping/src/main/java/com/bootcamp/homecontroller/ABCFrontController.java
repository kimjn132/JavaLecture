 ...
 */
@WebServlet("*.do")
public class ABCFrontController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ABCFrontController() {
		super();
...
//			   break;
		...
		case ("/host_check.do"):
			...
			String cPw3 = request.getParameter("cPw");
			String hId = null;
			HostCheckDao dao3 = new HostCheckDao();
			int hSeq = dao3.checkHostLogin(cId3, cPw3);
			if (hSeq != 0) {
				hId = cId3;
