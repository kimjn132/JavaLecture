					...
					<div class="my-3">
						<div class="form-check">
							<input id="credit" name="oPayment" type="radio"
								class="form-check-input" checked="checked" value="credit"> <label
						...
						<div class="form-check">
							<input id="debit" name="oPayment" type="radio"
								class="form-check-input" value="checkcard"> <label
						...
						<div class="form-check">
							<input id="deposit without a bankbook" name="oPayment"
								type="radio" class="form-check-input" value="cash"> <label
